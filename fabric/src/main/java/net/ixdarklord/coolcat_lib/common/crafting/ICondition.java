...
public interface ICondition {
    static boolean shouldRegisterEntry(JsonElement json) {
        if (!(json instanceof JsonObject obj) || !obj.has("ultimine_addition:conditions"))
            return true;

        return CraftingHelper.processConditions(obj, "ultimine_addition:conditions", IContext.TAGS_INVALID);
    }
