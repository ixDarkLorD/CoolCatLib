 ...
 */
public class NeoForgeLanguageWrapper extends net.neoforged.neoforge.common.data.LanguageProvider {
     ...
     */
    public NeoForgeLanguageWrapper(PackOutput output, String modid, LanguageProvider provider) {
     ...
     * @param provider The internal language provider.
     */
    public NeoForgeLanguageWrapper(PackOutput output, String modid, String locale, LanguageProvider provider) {
     ...
     * @return A {@link DataProvider.Factory} instance producing {@link NeoForgeLanguageWrapper} objects for {@code en_us}.
     */
    public static DataProvider.Factory<NeoForgeLanguageWrapper> factory(String modid, Supplier<LanguageProvider> supplier) {
     ...
     * @param supplier A supplier that creates the wrapped {@link LanguageProvider}.
     * @return A {@link DataProvider.Factory} instance producing {@link NeoForgeLanguageWrapper} objects for the specified locale.
     */
    public static DataProvider.Factory<NeoForgeLanguageWrapper> factory(String modid, String locale, Supplier<LanguageProvider> supplier) {
        return output -> new NeoForgeLanguageWrapper(output, modid, locale, supplier.get());
    }
}
