...
public class ColorableImageButton extends ImageButton {
   ...
   public ColorableImageButton(int pX, int pY, int pWidth, int pHeight, int pXTexStart, int pYTexStart, ResourceLocation resourceLocation, OnPress onPress) {
      this(pX, pY, pWidth, pHeight, pXTexStart, pYTexStart, pHeight, resourceLocation, 256, 256, onPress);
   }

   public ColorableImageButton(int pX, int pY, int pWidth, int pHeight, int pXTexStart, int pYTexStart, int pYDiffTex, ResourceLocation resourceLocation, OnPress onPress) {
      this(pX, pY, pWidth, pHeight, pXTexStart, pYTexStart, pYDiffTex, resourceLocation, 256, 256, onPress);
   }

   public ColorableImageButton(int pX, int pY, int pWidth, int pHeight, int pXTexStart, int pYTexStart, int pYDiffTex, ResourceLocation resourceLocation, int pTextureWidth, int pTextureHeight, OnPress onPress) {
   ...
   public ColorableImageButton(int pX, int pY, int pWidth, int pHeight, int pXTexStart, int pYTexStart, int pYDiffTex, ResourceLocation pResourceLocation, int pTextureWidth, int pTextureHeight, OnPress pOnPress, Component pMessage) {
