...
public class FabricLanguageWrapper extends FabricLanguageProvider {
    ...
    public FabricLanguageWrapper(FabricDataOutput output, String locale, LanguageProvider provider) {
        super(output, locale);
     ...
     */
    public static FabricDataGenerator.Pack.Factory<FabricLanguageWrapper> factory(Supplier<LanguageProvider> supplier) {
     ...
     */
    public static FabricDataGenerator.Pack.Factory<FabricLanguageWrapper> factory(String locale, Supplier<LanguageProvider> supplier) {
        return output -> new FabricLanguageWrapper(output, locale, supplier.get());
    }
}
