...
public final class EventResultHolder<T> {
    ...
    @NotNull
    private final net.ixdarklord.coolcatlib.api.event.v2.core.EventResult result;
    @NotNull
    ...
    private EventResultHolder() {
        this.result = net.ixdarklord.coolcatlib.api.event.v2.core.EventResult.PASS;
        this.value = null;
    }
     ...
     * private constructor
     */
    private EventResultHolder(@NotNull net.ixdarklord.coolcatlib.api.event.v2.core.EventResult result, @NotNull T value) {
    ...
    public static <T> EventResultHolder<T> interrupt(@NotNull T value) {
        return new EventResultHolder<>(net.ixdarklord.coolcatlib.api.event.v2.core.EventResult.INTERRUPT, value);
    }
    ...
    public static <T> EventResultHolder<T> allow(@NotNull T value) {
        return new EventResultHolder<>(net.ixdarklord.coolcatlib.api.event.v2.core.EventResult.ALLOW, value);
    }
    ...
    public static <T> EventResultHolder<T> deny(@NotNull T value) {
        return new EventResultHolder<>(net.ixdarklord.coolcatlib.api.event.v2.core.EventResult.DENY, value);
    }
