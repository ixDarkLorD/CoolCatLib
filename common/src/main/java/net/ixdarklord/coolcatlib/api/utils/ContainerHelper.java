...
public final class ContainerHelper {
    ...
    public static boolean equals(Player a, Player b) {
        ...
        for (int i = 0; i < a.getInventory().getContainerSize(); i++) {
            if (!ItemStack.isSameItemSameComponents(a.getInventory().getItem(i), b.getInventory().getItem(i))) return false;
        }
        return true;
    }
    ...
    public static int hashCode(Player player) {
        ...
        for (int i = 0; i < player.getInventory().getContainerSize(); i++) {
            code += (ItemStack.hashItemAndComponents(player.getInventory().getItem(i)) * 2);
        }
        return code;
    }
}
